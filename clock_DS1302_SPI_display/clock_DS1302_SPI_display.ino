...
volatile int myNumber[] = {2, 4, 8, 3, 6, 0, 0, 0};
...
ISR(TIMER1_COMPA_vect)          // timer compare interrupt service routine
  ...
  unsigned char num = myNumber[ledCounter%8];
  ...
  if ( num == 8 )  SPI.transfer(255 - B01111111);//0
  if ( num == 9 )  SPI.transfer(255 -B01101111);//0
